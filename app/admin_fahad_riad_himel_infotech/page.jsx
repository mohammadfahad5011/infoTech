...
export default function AdminLayout() {
    ...
    try {
      if (formType === "project") {
        ...
        if (currentItem) {
          // Update project
          await fetch(
            `https://info-tech-rho.vercel.app/api/projects/${currentItem.id}`,
            {
              method: "PUT",
          ...
          // Add project
          await fetch("https://info-tech-rho.vercel.app/api/projects", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(payload),
          });
  ...
  const handleDelete = async (type, id) => {
    try {
      if (type === "project") {
        await fetch(`https://info-tech-rho.vercel.app/api/projects/${id}`, {
          method: "DELETE",
        });
